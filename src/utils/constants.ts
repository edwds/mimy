...
export const LIKERT_MAP: Record<number, number> = {
  1: -2,
  2: -1,
  3: 0,
  4: 1,
...
export const QUIZ_OPTIONS = [
  { key: 'veryYes', label: '매우 그렇다', val: 5, color: 'hover:border-orange-500 hover:bg-orange-50' },
  { key: 'yes', label: '약간 그렇다', val: 4, color: 'hover:border-orange-400 hover:bg-orange-50' },
  { key: 'neutral', label: '보통이다', val: 3, color: 'hover:border-slate-300 hover:bg-slate-50' },
  { key: 'no', label: '별로 그렇지 않다', val: 2, color: 'hover:border-blue-400 hover:bg-blue-50' },
  { key: 'veryNo', label: '전혀 그렇지 않다', val: 1, color: 'hover:border-blue-500 hover:bg-blue-50' },
];
